...
public class FlowControllerV1 {
    ...
    public Result<FlowRuleEntity> apiAddFlowRule(@RequestBody FlowRuleEntity entity) {
        ...
        try {
            ...
            if(persistentApiClient instanceof MemoryApiClient){
                ...
                this.publishRules_persistence(entity.getApp(), entity.getIp(), entity.getPort()).get(5000, TimeUnit.MILLISECONDS);
            }
    ...
    public Result<Long> apiDeleteFlowRule(Long id) {
        ...
        try {
            ...
            if(persistentApiClient instanceof MemoryApiClient){
                ...
                this.publishRules_persistence(oldEntity.getApp(), oldEntity.getIp(), oldEntity.getPort()).get(5000, TimeUnit.MILLISECONDS);
            }
    ...
    private CompletableFuture<Void> publishRules_persistence(/*@NonNull*/ String app, String ip, Integer port) throws Exception {
