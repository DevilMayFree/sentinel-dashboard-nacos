...
public class AuthorityRuleController {
    ...
    private boolean publishRules_persistence(/*@NonNull*/ String app, String ip, Integer port) {
        ...
        boolean sentinelResult = sentinelApiClient.setAuthorityRuleOfMachine(app, ip, port, rules);
        boolean persistentResult = persistentApiClient.publishReturnBoolean(app, RuleConfigTypeEnum.AUTHORITY, rules);
