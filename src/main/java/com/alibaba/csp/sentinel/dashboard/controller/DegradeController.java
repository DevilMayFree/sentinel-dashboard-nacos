...
public class DegradeController {
    ...
    public Result<DegradeRuleEntity> apiAddRule(@RequestBody DegradeRuleEntity entity) {
        ...
        if(persistentApiClient instanceof MemoryApiClient) {
            ...
            if (!this.publishRules_persistence(entity.getApp(), entity.getIp(), entity.getPort())) {
                logger.warn("Publish degrade rules failed, app={}", entity.getApp());
            }
        }
    ...
    public Result<DegradeRuleEntity> apiUpdateRule(@PathVariable("id") Long id,
        ...
        if(persistentApiClient instanceof MemoryApiClient) {
            ...
            if (!publishRules_persistence(entity.getApp(), entity.getIp(), entity.getPort())) {
                logger.warn("Publish degrade rules failed, app={}", entity.getApp());
            }
        }
    ...
    public Result<Long> delete(@PathVariable("id") Long id) {
        ...
        if(persistentApiClient instanceof MemoryApiClient) {
            ...
            if (!publishRules_persistence(oldEntity.getApp(), oldEntity.getIp(), oldEntity.getPort())) {
                logger.warn("Publish degrade rules failed, app={}", oldEntity.getApp());
            }
        }
    ...
    private boolean publishRules_persistence(/*@NonNull*/ String app, String ip, Integer port) {
        ...
        boolean sentinelResult = sentinelApiClient.setDegradeRuleOfMachine(app, ip, port, rules);
        boolean persistentResult = persistentApiClient.publishReturnBoolean(app, RuleConfigTypeEnum.DEGRADE, rules);
        return sentinelResult && persistentResult;
    }
